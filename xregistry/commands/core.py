# pylint: disable=missing-module-docstring, global-statement, global-variable-not-assigned, invalid_name
import json
import os
...
# information set
def load_definitions_core(definitions_file: str, headers: dict, ignore_handled: bool = False) -> Tuple[str|None, JsonNode]:
    """ Load the definition file, which may be a JSON Schema"""
    docroot: JsonNode = {}
    global current_url
    try:
...
def load_definitions(definitions_file: str, headers: dict, load_schema: bool = False, ignore_handled: bool = False) -> Tuple[str|None, JsonNode]:
    """ Load the definition file, which may be a JSON Schema """
