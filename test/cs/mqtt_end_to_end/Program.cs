...
public class Program
{
    public static async Task<int> Main(string[] args)
    {
        ...
        var consumer = EventsEventConsumer.CreateForMqttConsumer(logger, passwordCredential, new EventsEventDispatcher(unmatchedEvents));
        await consumer.Endpoint.StartAsync();

        var producer = EventsEventProducer.CreateForMqttProducer(logger, passwordCredential, ContentMode.Structured, formatter);
