...
public class Program
{
    public static async Task<int> Main(string[] args)
    {
        ...
        await producer.SendReservationPlacedAsync(new Contoso.ERP.Producer.Contoso.ERP.Events.OrderData()
        {
            ...
            OrderId = "abc",
            Total = 1000,
            Items = new List<global::Contoso.ERP.Producer.Contoso.ERP.Events.OrderdataTypes.Items>()
            {
                new global::Contoso.ERP.Producer.Contoso.ERP.Events.OrderdataTypes.Items() {
                    ProductId = "123",
                    Price = 10,
                    Quantity = 5
                }
